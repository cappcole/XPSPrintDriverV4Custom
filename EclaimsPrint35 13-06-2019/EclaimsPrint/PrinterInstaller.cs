...
namespace EclaimsPrint
{
    public class PrinterInstaller
    {
        ...
        //9001
        private string driverName = "Microsoft XPS Document Writer"; //Or custom driver if you have one, cant have mine ;) 
        private string printerName = "CustomXPSDriver";
        private string PrinterPortName = "CustomListener";
        ...
        //*******************************************************************************//
        internal void InstallPrinterWMI()
        {
            ...
            try
            {
                ...
                //if(is64Bit) // if built in  .net 3.5 you dont not need this. If newer version you will. 
                {
